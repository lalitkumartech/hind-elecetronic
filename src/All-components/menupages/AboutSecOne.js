        ...
        <>
            <Box className="whychoose-sec">
                <Container>
                    ...
                    <Grid container>
                        <Box className="whychoose_card">
                            <Typography className="heading-text" variant="h2">Where does it come from?</Typography>
                            <Typography className="peragraph-text">Contrary to popular belief, Lorem Ipsum is not simply random text.
                                ...
                                Malorum" (The Extremes of Good and Evil) by Cicero, written in 45 BC. This book is a treatise on the theory of ethics, very popular during the Renaissance.
                                The first line of Lorem Ipsum, "Lorem ipsum dolor sit amet..", comes from a line in section 1.10.32
                            </Typography>
                            <br/>
                            <Typography className="peragraph-text">
